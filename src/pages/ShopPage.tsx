...
const subcategories = [
  ...
  { id: "2", name: "Hoodies", categoryId: "1" },
  { id: "3", name: "Jeans", categoryId: "1" },
  { id: "4", name: "Sneakers", categoryId: "2" },
  { id: "5", name: "Boots", categoryId: "2" },
  { id: "6", name: "Sandals", categoryId: "2" },
  { id: "7", name: "Phones", categoryId: "3" },
  { id: "8", name: "Laptops", categoryId: "3" },
  { id: "9", name: "Accessories", categoryId: "3" },
];
          ...
          <div className="mb-6">
            ...
            <div className="flex overflow-x-auto pb-2 space-x-3 scrollbar-hide">
              {filteredSubcategories.map((subcategory) => (
                <div
                  key={subcategory.id}
                  className="bg-gray-100 px-4 py-2 rounded-full text-gray-700 whitespace-nowrap"
                >
                  {subcategory.name}
                </div>
              ))}
